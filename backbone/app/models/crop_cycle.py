...
from sqlalchemy import String, Date, DateTime, ForeignKey, func, Index
...
class CropCycle(Base):
    ...
    def __repr__(self) -> str:
        return f"<CropCycle(id={self.id}, field_id={self.field_id}, crop={self.crop}, status={self.status})>"
